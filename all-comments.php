...
<div class="container-fluid" style="padding: ;">
                <h1 class="span" style="">All Comments</h1>
            ...
            <span class="comments-top"></span>
                <!-- start of ads details -->
                <div class="col-sm-8" style="margin-bottom:50px;">
                 
                        <br>
                        <div class="float" style="">
                            <textarea class="comment-input" style="height: 75%;width: 100%;border-radius: ;border:0.5px solid #1f253d;background-color: ;color: #1f253d;padding: 10px;display: none;" placeholder="Enter your comment here..."></textarea>
                            <button class="show-comment" style="border:1px solid #1f253d;background-color: #1f253d;color: white;border-radius: 6px;padding: 4px 10px;">Drop a comment</button>

                            <button class="send-comment" id="send-comment" style="border:1px solid #1f253d;background-color: #1f253d;color: white;border-radius: 6px;padding: 4px 10px;display: none;">SEND</button> <span style="margin-left: 10px;color: mediumseagreen;display: none;" class="success" >Comment sent..</span>
                                <span style="margin-left: 10px;color: crimson;display: none;" class="error" >Empty field..</span>
                        </div>


                        <div class="all_comments" style="max-height: ;background-color: ;position: relative;width: 100%;overflow: auto;">
                            <?php
                    ...
                    <div class="card shadow mb-4" style="width: 100% !important;margin-left: 3.4%;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <span style="color: ;">Today's Leaders Board</span>
                            </h6>
                        </div>
                        <div class="card-body" style="padding: 0px;">
                               ...
                               <?php
                                $date=date("Y-m-d");
                                $sql2 = "SELECT * FROM qst_counter WHERE date='$date' ORDER BY rating DESC"; 
