    ...
    <div id="layoutSidenav_content" style="height: 100vh !important;">
        <main>
            ...
            <div class="sidebar" style="background-color: ;width: 25%;height: 100%;border-left: 0.5px solid #eee;position: fixed;right: 0px;z-index: 0;overflow: auto;padding-left: 10px;padding-bottom:9%;top: 0px;padding-top: 5%;">
                ...
                <div class="category-title" style="position: fixed;background-color: white;right: 0px;width: 23%;text-align: left;font-weight: lighter;color: grey;font-size: 16px;">Leaders Board</div>
                <br><br><br>
                <?php
                        $get=$_GET['id'];
...
<div style="width: ;height:;background-color: ;position: relative;left:5%;border-radius: 10px;padding: 15px 2px;font-weight: bold;font-size: 18px;">
                        ...
                        if (mysqli_num_rows($result)) {
                           ...
                           <br>
                            ...
                            <a class="start retryExa" data-category="<?php echo $get; ?>" data-user="<?php echo $user; ?>" href="leagues.php?cat=<?php echo $_GET['id']; ?>"><input value="Retry League" class="add-question" type="button" id="add-question" style="margin-left:;width:;height: 40px;border-radius: 7px;border:0.5px solid mediumseagreen;padding: 2px 4px;background-color:mediumseagreen;color: white;"></a>
                            ...
                            ?>
                            <br>
                            <a class="start" data-category="<?php echo $get; ?>" data-user="<?php echo $user; ?>" href="leagues.php?cat=<?php echo $_GET['id']; ?>"><input value="Start Examination" class="add-question" type="button" id="add-question" style="margin-left:;width:;height: 40px;border-radius: 7px;border:0.5px solid mediumseagreen;padding: 2px 4px;background-color:mediumseagreen;color: white;"></a>
                            <?php
    ...
    <div class="category-container" style="height:;background-color: ;box-shadow: 0px 2px 4px grey;width: 100%;margin-left: 3%;border-radius: 5px;text-align: left;margin-bottom: 20px;">
        ...
        <div class="category-title" style="font-weight: bold;font-size: 17px;">Leaders Board</div>
         <?php
                        $get=$_GET['id'];
                        $sql = "SELECT * FROM xtra_categories WHERE category_code='$get' "; 
                        $result = mysqli_query($conn, $sql);
