...
<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#343a40;">
    ...
    <a class="sideBar-home-btn" style="color: white;margin-left: 60px;font-weight: bold;font-size: 19px;" href="../"><i class="fa fa-home"></i> <span style="font-size: ;">Home</span></a>-->


    <a class="sideBar-home-btn" style="color: white;margin-left: 70px;font-weight: bold;font-size: 19px;" href="../admin.php?League"><i class="fa fa-plus-square"></i> <span style="font-size: ;">Create League</span></a>
                             ...
                             <?php
                                ...
                                while ($row=mysqli_fetch_assoc($result)) {
                                    ...
                                    $date=$row['date'];
                                        ...
                                        ?><a href="./?id=<?php echo $category_code; ?>" style="color:white;margin-top: ;">
