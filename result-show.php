                                    ...
                                    while ($row=mysqli_fetch_assoc($result)) {
                                        ...
                                        $date=$row['date']; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><a  class="retryExa" data-category="<?php echo $category_code; ?>" data-user="<?php echo $user; ?>" href="test.php?cat=<?php echo $category_code ?>"  style="background-color: mediumseagreen;padding: 3px 7px;border-radius: 6px;color: white;text-align: center;width: 100%;">
                                                        RETAKE
                                                    </a></td>
                                                </tr>
