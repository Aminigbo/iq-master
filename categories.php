...
<div class="container-fluid" style="padding: ;">
                ...
                <div class="col-sm-4" style="text-align: center!important;">
                    ...
                    <!-- Illustrations -->
                    <div class="card shadow mb-4" style="width: 100% !important;margin-left: 3.4%;display:  ;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">

                            <span class="data">Hello friends</span>
   ...
   ///  progressing users level when they click on ads
            $(".add-question").click(function() {
                ...
                success:function(data){
                    ...
                    // alert(question +"--"+option1+"--"+option2+"--"+option3+"--"+option4+"--"+category+"--")
