...
<div class="container-fluid" style="padding: ;">
                <h1 class="span" style=""><?php
                if (isset($_GET['exam'])) {
                    echo "Create an exam";
                }else{
                    echo "Create a league";
                }
                    ...
                    <div class="ad-container" style="width: 100% !important;text-align: center !important;">
                       ...
                       if (isset($_GET['exam'])) {
                          ?>
                           ...
                           <div style="width: ;height:;background-color: #eee;position: relative;left:5%;border-radius: 10px;padding: 15px 2px;">
                        ...
                        ?>
                           ...
                           <div style="width: ;height:;background-color: #eee;position: relative;left:5%;border-radius: 10px;padding: 15px 2px;">
                            <input class="category-input2" type="text" placeholder="Enter category" id="" class="" style="width: 70%;height: 40px;border-radius: 7px;border:0.5px solid #1f253d;padding: 2px 4px;">

                             <input class="point-input2" type="number" placeholder="Points" style="width: 30%;height: 40px;border-radius: 7px;border:0.5px solid #1f253d;padding: 2px 4px;">

                            <span class="add-category2" id="add-category2" style="padding: 5px 10px;background-color:#1f253d ;color: white;border-radius: 7px;cursor: pointer;">DONE</span>
                        </div> <br>

                        <div class="all_cat2" style="height: 500px;background-color: ;position: relative;width: ;left: 3%;text-align: left;padding-left: 5px;">
...
function all_category2(){
 ...
 ///  progressing users level when they click on ads
            $(".add-category2").click(function() {
                var add2 = $(this).attr('id'); 
                input=$('.category-input2').val();
                point=$('.point-input2').val();
                session_id=$('#session_id').val();
                $.ajax({
                url:"scripts.php",
                method:"POST",
